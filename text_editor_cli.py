...
"""
This is from URWID examples, modified to work with DiscoChat. We do not use it anymore since changing to class based ops. I decided to leave this in though because I think it is just a neat little quick and dirty text editor that fits with the feel of a homelab cli app. I am using URWID for an adventure game called AI Odyssey.
...
def main():
    ...
    name = sys.argv[1]
    try:
        assert open(f"agents/{name}/instructions.yaml", "a")  # noqa: SIM115,S101  # do not overcomplicate example
